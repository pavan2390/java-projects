...
import com.stockexample.stock.service.impl.UsaatServiceImpl;

@RestController
@RequestMapping("/usaat/loader")
public class UsaatController {

	private StockService stockService;
	
	@Autowired
	public UsaatController(UsaatServiceImpl stockService) {
		super();
		this.stockService = stockService;
	}

	@PostMapping("/upload")
	public ResponseEntity<String> uploadUsaatData(@RequestBody RequestDto requestDto) {
		System.out.println("!!! Inside Controller !!!");
		System.out.println("uploadUsaData - Method");
