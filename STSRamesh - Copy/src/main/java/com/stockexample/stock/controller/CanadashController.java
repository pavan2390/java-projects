...
@RestController
@RequestMapping("/canadash/loader")
public class CanadashController {
	
	private StockService stockService;
	
	@Autowired
	public CanadashController(CanadashServiceImpl stockService) {
		super();
		this.stockService = stockService;
	}

	@PostMapping("/upload")
	public ResponseEntity<String> uploadCanadashData(@RequestBody RequestDto requestDto) {
		System.out.println("!!! Inside Controller !!!");
		System.out.println("uploadCanadashData - Method");
